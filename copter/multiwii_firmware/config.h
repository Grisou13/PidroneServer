...
#define LAND_SPEED          100
  ...
  /********************************************************************/
    ...
    #define ALT_HOLD_THROTTLE_MIDPOINT        1100  // in us    - if uncommented, this value is used in ALT_HOLD for throttle stick middle point instead of initialThrottleHold parameter.
